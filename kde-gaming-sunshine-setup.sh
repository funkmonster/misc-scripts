...
echo "==> Installing core desktop and display stuff..."
sudo pacman -S --noconfirm plasma kde-applications sddm xdg-desktop-portal xdg-desktop-portal-kde
...
echo "==> All done. Reboot to start KDE + Wayland with gaming setup and Sunshine installed."
